...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        <div class="brand">
            <span class="logo-mark" style="width:32px;height:32px;flex-shrink:0;"><?php $logoSurFondSombre = true; include ROOT_PATH . '/assets/inc/logo.php'; ?></span>
        ...
        <nav>
            <?php if ($role === ROLE_ADMIN): ?>
                ...
                <?php sidebar_lien('admin/plats', '', 'Produits', $routeActuelle); ?>
                <?php sidebar_lien('admin/categories', '', 'Catégories', $routeActuelle); ?>
            ...
            <?php elseif ($role === ROLE_CLIENT): ?>
                ...
                <?php sidebar_lien('client', '', 'Menu', $routeActuelle); ?>
