 ...
 * l'historique du dépôt. La page "Livraisons" (zones de livraison) est
 * désormais servie par controleur/admin/ZoneControleur.php +
 * vue/admin/zones.php, via le routeur (urlRewrite.php).
 *
 ...
 */
header('Location: ../index.php?route=admin/zones');
exit;
