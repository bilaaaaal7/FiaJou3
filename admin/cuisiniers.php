 ...
 * l'historique du dépôt. La page "Cuisiniers" est désormais servie par
 * controleur/admin/CuisinierControleur.php + vue/admin/cuisiniers.php,
 ...
 */
header('Location: ../index.php?route=admin/cuisiniers');
exit;
=======
