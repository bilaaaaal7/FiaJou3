...
<div style="max-width: 1000px; margin: 0 auto;">
    ...
    <div class="two-col">
        ...
        <div>
            <div class="panel">
                <h2 data-i18n="livreur_detail.infosTitre">Informations de la commande</h2>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="tel:<?php echo htmlspecialchars($commande['telephone']); ?>" style="color:var(--gold-dark); text-decoration:none;"><?php echo htmlspecialchars($commande['telephone']); ?></a>
                                    <?php else: ?>-<?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="font-weight: 600;" data-i18n="common.ville">Ville</td>
            ...
            <div class="panel">
                <h2 data-i18n="livreur_detail.articlesLivres">Articles livrés</h2>
                <?php if (!empty($items)): ?>
                <div class="table-wrap">
                    <table class="data-table">
                        <thead>
